...
export const StoriesCursor: React.FC<CursorProps> = ({ x, y, isHovering, isClicking }) => {
  return (
    <motion.div
        ...
        <svg width="100%" height="100%" viewBox="0 0 30 40">
          <defs>
            <radialGradient id="flameGlow">
              <stop offset="0%" stopColor="rgba(255, 150, 50, 0.8)" />
              <stop offset="50%" stopColor="rgba(255, 100, 0, 0.4)" />
              <stop offset="100%" stopColor="transparent" />
            </radialGradient>
          </defs>
          {/* Glow */}
          <ellipse cx="15" cy="20" rx="20" ry="25" fill="url(#flameGlow)" />
          {/* Flame */}
          <motion.path
